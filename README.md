# CosmWasm testing contracts

These contracts are intended for development and testing purposes only.
For more realistic example contracts, see [cw-plus](https://github.com/CosmWasm/cw-plus/tree/main/contracts).

## The contracts

Introducing the testing contracts in the order they were created.
...
9. **cyberpunk** is an attempt to clean up hackatom and make writing runtime
